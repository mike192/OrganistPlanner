...
import pl.mosenko.songplanner.data.set_of_songs.SET_OF_SONGS_TABLE
...
import pl.mosenko.songplanner.data.songbook_song.*
...
interface RowDao : BaseDao<Row> {
    ...
    @Query(
        "select r.$COLUMN_ID as rowId, pom.$PART_OF_MASS_NAME_COLUMN as partOfMassName," +
